# Prototype-Calibrated-Learning-Framework

This repository provides the official PyTorch implementation for the paper:

**Prototype-Calibrated Learning for Multi-Class Cell Detection in Histological Images with Sparse Annotations**
